...
(function_declaration (identifier) @definition.function.depth.1)
(variable_declarator (identifier) @definition.function.depth.1 (arrow_function))
(method_definition (property_identifier) @definition.function.depth.1)
(pair (property_identifier) @definition.function.depth.1 (arrow_function))
